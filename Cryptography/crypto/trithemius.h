...
char __alpha_trithemius[MAX_CHAR_QUANTITY] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
char __length_trithemius = LEN_ALPHA;

char _char_trithemius (const char mode, char key, const char ch) {
    char *p = NULL;
