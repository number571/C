...
char __alpha_polybius[MAX_CHAR_QUANTITY] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
char __length_polybius = 26;

char _get_length_of_square_polybius (void) {
    char square;
...
void _push_square_to_buffer_polybius (char * const buffer, const char square) {
...
_Bool set_alpha_polybius (char * const alpha) {
...
_Bool polybius (char * const to, const char mode, char * const from) {
